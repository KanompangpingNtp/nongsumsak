...
<body>
    ...
    <div class="box_text" style="text-align: start; margin-top:3rem;">
        <div style="margin-left: 5rem;">
            <span>เจ้าพนักงานท้องถิ่นอนุญาตให้</span>
            <input type="checkbox">
    ...
    <div class="box_text" style="text-align: start; margin-top:1rem; ">
        <div style="margin-left: 5rem;">
            <span style="font-weight: bold; margin-right:5px;">ข้อ ๑.</span><span> ประกอบกิจการที่เป็นอันตรายต่อสุขภาพประเภท</span>
    ...
    <div class="box_text">
        ...
        <span>พื้นที่ประกอบกิจการ</span>
        <span class="dotted-line" style="width: 21%; text-align: center; line-height: 1;"></span>
        <span>ตารางเมตร กำลังเครื่องจักร</span>
        <span class="dotted-line" style="width: 10%; text-align: center; line-height: 1;"></span>
        <span>แรงม้า จำนวนคนงาน</span>
        <span class="dotted-line" style="width: 10%; text-align: center; line-height: 1;"></span>
        <span>คน</span>
    ...
    <div class="box_text" style="text-align: start; margin-top:1rem; ">
        <div style="margin-left: 5rem;">
            ...
            <span>(๑) ต้องปฎิบัติตามเทศบัญญัติเทศบาลตำบลหนองซ้ำซากว่าด้วยกิจการที่เป็นอันตรายต่อสุขภาพ พ.ศ. ๒๕๕๙</span>
        </div>
    </div>
