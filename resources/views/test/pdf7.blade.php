...
<body>
    <div style="width: 100%; position: relative; margin-bottom: 10px;">
        ...
        <div style="text-align: center; font-weight: bold; font-size: 26px;">
            ...
            <span>ประกอบกิจการรับทำการเก็บ ขน หรือกำจัดสิ่งปฎิกูลหรือมูลฝอย</span>
        </div>
    ...
    <div class="box_text">
        ...
        <span class="dotted-line" style="width: 15.2%; text-align: center; line-height: 1;"></span>
        <span>หมู่ที่</span>
        <span class="dotted-line" style="width: 15.2%; text-align: center; line-height: 1;"></span>
        <span>ตรอก/ซอย</span>
        <span class="dotted-line" style="width: 15.2%; text-align: center; line-height: 1;"></span>
    ...
    <div class="box_text" style="text-align: start; margin-top:1rem; ">
        <div style="margin-left: 5rem;">
            <span> ข้อ ๑. ประกอบกิจการรับทำการเก็บ ขนน หรือกำจัดสิ่งปฎิกูลหรือมูลฝอย</span>
        </div>
    </div>
    <div class="box_text">
        <span>ประเภท</span>
        ...
        <span class="dotted-line" style="width: 15.3%; text-align: center; line-height: 1;"></span>
        <span>หมู่ที่</span>
        <span class="dotted-line" style="width: 15.3%; text-align: center; line-height: 1;"></span>
        <span>ตำบล/แขวง</span>
        <span class="dotted-line" style="width: 15.3%; text-align: center; line-height: 1;"></span>
    ...
    <div class="box_text" style="text-align: start; margin-top:1rem; ">
        <div style="margin-left: 5rem;">
            ...
            <span>(๑) ต้องปฎิบัติตามเทศบัญญัติเทศบาลตำบลหนองซ้ำซากว่าด้วยการจัดการสิ่งปฎิกูลและมูลฝอย พ.ศ. ๒๕๕๕</span>
        </div>
    </div>
    <div class="box_text" style="text-align: right; margin-top:2rem; ">
        <div style="margin-left: 5rem;">
            <span style="font-weight: bold;">ใบอนุญาตฉบับนี้ให้ใช้ได้จนถึงวันที่</span>
    ...
    <div class="box_text" style="text-align: right; margin-top:2rem; margin-left:15rem;">
    ...
    <div class="box_text" style="text-align: center; font-weight: bold;">
        <span>ชื่อจริง นามสกุล</span><br>
        <span>ที่อยู่</span> <br>
        <div style="margin-top: 3rem;">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/pdf/ครุฑ.png'))) }}"
        alt="Logo" height="180" style="margin-top: 3rem;"><br>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/pdf/ครุฑ.png'))) }}"
                alt="Logo" height="180" style="margin-top: 3rem;"><br>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/pdf/ครุฑ.png'))) }}"
                alt="Logo" height="180" style="margin-top: 3rem;"><br>  
