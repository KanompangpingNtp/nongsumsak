                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control require" id="nationality" name="nationality"
                                    readonly value="{{ $form->nationality }}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input require" type="radio" name="type_option"
                                        id="type_option_1" value="1"
                                        {{ $form->type_option == '1' ? 'checked' : '' }} required readonly>
                                    <label class="form-check-label" for="type_option_1">1</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input require" type="radio" name="type_option"
                                        id="type_option_2" value="2"
                                        {{ $form->type_option == '2' ? 'checked' : '' }} required readonly>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control require" id="submit_village"
                                    name="submit_village" value="{{ $form->submit_village }}" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control require" id="submit_sub_district"
                                    name="submit_sub_district" value="{{ $form->submit_sub_district }}" required
                                    readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control require" id="receipt_number"
                                    name="receipt_number" value="{{ $form->receipt_number }}" readonly>
                            </div>
