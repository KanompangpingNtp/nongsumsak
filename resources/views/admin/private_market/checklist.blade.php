            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('PrivateMarketAdminChecklistSave') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-7">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="list_option[]" value="option_1"
                                        id="option1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="list_option[]" value="option_2"
                                        id="option2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="list_option[]" value="option_3"
                                        id="option3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="list_option[]" value="option_4"
                                        id="option4">
                        ...
                        <button type="submit" class="btn btn-primary py-1"><i class="fa fa-save"></i></i>
                            บันทึกข้อมูล</button>
