...
@php
    ...
    $createdDate = $form->created_at ?? null;
    $createdCarbon = \Carbon\Carbon::parse($createdDate)->locale('th');
    $createdDay = $createdCarbon->isoFormat('D');
    $createdMonth = $createdCarbon->isoFormat('MMMM');
    $createdYear = $createdCarbon->year + 543;
@endphp
...
<body>
    ...
    <div style="width: 100%; position: relative; margin-bottom: 30px;">
        ...
        <div class="box_text" style="position: absolute; top: 0; right: 0; width:50%; text-align: right;">
            ...
            <span class="dotted-line" style="width: 45%; text-align: center; line-height: 1;">เทศบาลตำบลหนองซ้ำซาก</span>
        </div>
    </div>
    ...
    <div class="box_text">
        ...
        <span class="dotted-line"
            style="width: 18%; text-align: center; line-height: 1;">{{ $form['details']->receipt_number ?? '-' }}</span>
        <span>ลงวันที่</span>
    ...
    <div class="box_text" style="text-align: start; margin-top:5rem; ">
        <div style="margin-left: 5rem;">
            ...
            <span class="dotted-line" style="width: 10%; text-align: center; line-height: 1;">{{ $createdDay }}</span>
            <span style="font-weight: bold;">เดือน</span>
            <span class="dotted-line" style="width: 20%; text-align: center; line-height: 1;">{{ $createdMonth }}</span>
            <span style="font-weight: bold;">พ.ศ.</span>
            <span class="dotted-line" style="width: 10%; text-align: center; line-height: 1;">{{ $createdYear }}</span>
        </div>
    </div>
