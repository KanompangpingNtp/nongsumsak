                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('AdminCertificateFoodCollectionPDF', $form->id) }}" class="badge rounded-pill text-success" target="_blank">
                                    ออกใบอนุญาต
                                </a>
                                <a href="{{ url('storage/'.$form->payment->file_treasury) }}" class="badge rounded-pill text-primary" target="_blank">
                                    ใบเสร็จกองคลัง
                                </a>
                                @endif
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary btn-sm" onclick="confirmExtendLeave({{ $form->id }})">
                                ...
                                $.ajax({
                                    ...
                                    , success: function(response) {
                                        if (response.success) {
                                            ...
                                            Swal.fire('เกิดข้อผิดพลาด', response.message || 'ไม่สามารถดำเนินการได้', 'error');
                                        }
                                    }
                                    , error: function() {
