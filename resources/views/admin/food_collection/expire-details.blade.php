    ...
    <div class="">
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('CertificateFoodCollectionExpire') }}" class="row g-2 mb-4">
                    <div class="col-md-2">
                        <select name="month" class="form-select">
                            <option value="">-- เลือกเดือน --</option>
                            @foreach(range(1, 12) as $m)
                            <option value="{{ $m }}" {{ request('month') == $m ? 'selected' : '' }} {{ !in_array($m, $availableMonths->toArray()) ? 'disabled' : '' }}>
                    ...
                    <div class="col-md-2">
                        <select name="year" class="form-select">
                            ...
                            <option value="{{ $y }}" {{ request('year') == $y ? 'selected' : '' }} {{ !in_array($y, $availableYears->toArray()) ? 'disabled' : '' }}>
                                {{ $y + 543 }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-warning"> {{ \Carbon\Carbon::parse($form->payment->expiration_date)->format('Y-m-d') }}</span>
                                @else
                            ...
                            <td>
                                ...
                                <a href="{{ route('AdminCertificateFoodCollectionPDF', $form->id) }}" class="badge rounded-pill text-bg-success" target="_blank" style="color: blue;">
                                    ออกใบอนุญาต
                                </a>
                            ...
                            <td>
                                ...
                                <a href="{{ route('FoodCollectionAdminDetail', $form->id) }}" class="btn btn-success btn-sm">
