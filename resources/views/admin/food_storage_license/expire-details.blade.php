    ...
    <div class="">
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('FoodStorageLicenseExpire') }}" class="row g-2 mb-4">
                    <div class="col-md-2">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('AdminCertificateFoodStorageLicensePDF', $form->id) }}" class="badge rounded-pill text-bg-success" target="_blank" style="color: blue;">
                                    ออกใบอนุญาต
                                </a>
