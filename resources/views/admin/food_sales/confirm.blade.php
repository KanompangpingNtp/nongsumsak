...
@section('content')
    ...
    <div class="row">
        <div class="">
            <div class="card">
                <div class="card-body">
                    <h2 class="text-center mb-4">แบบคำร้องใบอนุญาตจัดตั้งสถานที่จำหน่ายอาหาร</h2>

                    <form action="{{ route('FoodSalesAdminConfirmSave') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <p><strong>1. </strong>ดำเนินการจัดตั้งสถานที่จำหน่ายอาหารประเภท</p>
                                <input type="text" class="form-control" id="food_type" name="food_type"
                                    value="{{ $form->details->food_type }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="worker_count" name="worker_count"
                                    value="{{ $form->details->number_of_workers }}" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="business_address_no"
                                    name="business_address_no" value="{{ $form->details->location_address }}" readonly>
                            </div>
